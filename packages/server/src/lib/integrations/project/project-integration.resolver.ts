...
import { ProjectIntegrationCreateProjectInput, ProjectIntegrationCreateProjectMemberInput } from "./types-input/project-integration-project-create.input-type";
...
export class ProjectIntegrationResolver {
    ...
    async projects(): Promise<PaginatedResponse<ProjectIntegrationProjectObject>> {
