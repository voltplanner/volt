...
-- CreateTable
CREATE TABLE "tasks"."task_user_action" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "task_user_action_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "tasks"."task_user_permission" (
    "id" UUID NOT NULL,
    "role_id" UUID NOT NULL,
    "action_id" UUID NOT NULL,
    "is_ allowed" BOOLEAN NOT NULL DEFAULT false,
    "created_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deleted_at" TIMESTAMP(6),
    "is_deleted" BOOLEAN NOT NULL DEFAULT false,

    CONSTRAINT "task_user_permission_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "task_user_role_code_key" ON "tasks"."task_user_role"("code");

-- CreateIndex
CREATE UNIQUE INDEX "task_user_role_code_is_deleted_key" ON "tasks"."task_user_role"("code", "is_deleted");

-- CreateIndex
CREATE UNIQUE INDEX "task_user_action_code_key" ON "tasks"."task_user_action"("code");

-- CreateIndex
CREATE UNIQUE INDEX "task_user_action_code_is_deleted_key" ON "tasks"."task_user_action"("code", "is_deleted");

-- CreateIndex
CREATE UNIQUE INDEX "task_user_permission_role_id_action_id_is_deleted_key" ON "tasks"."task_user_permission"("role_id", "action_id", "is_deleted");

-- CreateIndex
CREATE UNIQUE INDEX "task_status_code_key" ON "tasks"."task_status"("code");

-- CreateIndex
CREATE UNIQUE INDEX "task_status_code_is_deleted_key" ON "tasks"."task_status"("code", "is_deleted");

-- CreateIndex
CREATE UNIQUE INDEX "task_status_position_is_deleted_key" ON "tasks"."task_status"("position", "is_deleted");

-- CreateIndex
CREATE UNIQUE INDEX "task_tag_code_key" ON "tasks"."task_tag"("code");

-- CreateIndex
CREATE UNIQUE INDEX "task_tag_code_is_deleted_key" ON "tasks"."task_tag"("code", "is_deleted");

-- CreateIndex
CREATE UNIQUE INDEX "task_tag_position_is_deleted_key" ON "tasks"."task_tag"("position", "is_deleted");

-- CreateIndex
CREATE UNIQUE INDEX "task_relation_code_key" ON "tasks"."task_relation"("code");

-- CreateIndex
CREATE UNIQUE INDEX "task_relation_code_is_deleted_key" ON "tasks"."task_relation"("code", "is_deleted");

-- CreateIndex
CREATE UNIQUE INDEX "task_relation_position_is_deleted_key" ON "tasks"."task_relation"("position", "is_deleted");
...
-- AddForeignKey
ALTER TABLE "tasks"."task_user_permission" ADD CONSTRAINT "FK__USER_PERMISSION__ROLE" FOREIGN KEY ("role_id") REFERENCES "tasks"."task_user_role"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tasks"."task_user_permission" ADD CONSTRAINT "FK__USER_PERMISSION__ACTION" FOREIGN KEY ("action_id") REFERENCES "tasks"."task_user_action"("id") ON DELETE CASCADE ON UPDATE CASCADE;
