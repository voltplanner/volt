...
export interface GetAvailableMethodsInput {
    name: Scalars['String']
...
export const isAvailableMethodsType = (
    obj?: { __typename?: any } | null,
): obj is AvailableMethodsType => {
    if (!obj?.__typename)
        throw new Error('__typename is missing in "isAvailableMethodsType"')
